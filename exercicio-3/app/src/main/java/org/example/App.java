...
public class App {
    ...
    /*
    Essa função cria posições para todos os barcos no tabuleiro, sendo o algoritmo responsável por:
        - Gerar uma posição inicial aleatória (por linha e coluna).
        - Verificar se a posição e a direção escolhida estão livres com a função 'verificando_posicoes'.
        - Colocar os barcos no tabuleiro com 'inserir_barco'.
    E se uma das etapas falhar por acaso, o processo será parado e repetido do começo.
    */
